...
class PreferencesThinClientTerminalDialog(gtk.Dialog):
    __gtype_name__ = "PreferencesThinClientTerminalDialog"
    preferences = {}
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated PreferencesThinClientTerminalDialog object.
        """
        builder = get_builder('PreferencesThinClientTerminalDialog')
        new_object = builder.get_object("preferences_thin_client_terminal_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a PreferencesThinClientTerminalDialog object with it in order to
        finish initializing the start of the new PerferencesThinClientTerminalDialog
        instance.
        ...
        self._db_name = "thin-client-terminal"
        ...
        self._record_type = (
            "http://wiki.ubuntu.com/Quickly/RecordTypes/ThinClientTerminal/"
            "Preferences")
        self._preferences = self.get_preferences()
        # TODO: code for other initialization actions should be added here

    def get_preferences(self):
        """Return a dict of preferences for thin-client-terminal.
...
if __name__ == "__main__":
    dialog = PreferencesThinClientTerminalDialog()
    dialog.show()
